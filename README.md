...
- Optional `@cursor/sdk` bridge client for SDK-only workflows
...
- Unit tests for Cursor v1 request contracts, SSE parsing, cache persistence, app routing, push payloads, and SDK bridge request mapping
