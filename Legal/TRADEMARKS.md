...
Apple, iPhone, iPad, iOS, iPadOS, TestFlight, App Store, App Store Connect, and related marks belong to Apple Inc.

Runline's public source does not grant Apple distribution rights, signing assets, or App Store Connect access. Maintainer release credentials must stay private.

## Runline Name and Assets
...
- add private release, signing, or hosted-service identifiers to public source

Keep compatibility language factual and conservative.
